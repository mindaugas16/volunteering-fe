...
@Component({
  selector: 'app-sign-up-volunteer-form',
  templateUrl: './sign-up-volunteer-form.component.html',
  styleUrls: ['./sign-up-volunteer-form.component.scss']
})
export class SignUpVolunteerFormComponent implements OnInit {
  ...
  submit() {
    ...
    this.authService.signUp(this.form.value, UserRole.VOLUNTEER).subscribe(() => {
